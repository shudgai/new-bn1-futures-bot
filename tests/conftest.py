...
TEST_DEFAULTS = {
    ...
    "CHANNEL_PROFIT_REENTRY_MAX_CHASE_ATR": 0.0,
    "CHANNEL_PROFIT_ROOM_ATR_IN_STRONG_TREND": False,
    # 末端防追單過濾：既有測試在加入本功能前撰寫，預設固定關閉；
    # 需要驗證行為的測試請在測試內 monkeypatch 開啟（2026-09-12）。
    "CHANNEL_EXHAUSTION_FILTER_ENABLED": False,
    "CHANNEL_EXHAUSTION_MAX_RAIL_DEVIATION_PCT": 0.015,
    "CHANNEL_EXHAUSTION_WICK_BODY_RATIO": 1.0,
