...
| 時段／幣種／方向 | 候選 | 異常率：原始 → 保留 | 擋下異常 | 誤擋非異常 | 錯過正報酬代理 |
|---|---:|---:|---:|---:|---:|
| 舊資料驗證 | 748 | 24.5% → 21.9% | 69/183 | 158 (28.0%) | 39/136 (28.7%) |
| 近期 ALL ALL | 174 | 23.6% → 22.0% | 14/41 | 37 (27.8%) | 6/35 (17.1%) |
| 近期 1000PEPEUSDT LONG | 39 | 35.9% → 45.0% | 5/14 | 14 (56.0%) | 2/3 (66.7%) |
| 近期 1000PEPEUSDT SHORT | 56 | 19.6% → 20.5% | 3/11 | 14 (31.1%) | 1/6 (16.7%) |
| 近期 龙虾USDT LONG | 18 | 22.2% → 8.3% | 3/4 | 3 (21.4%) | 1/7 (14.3%) |
| 近期 龙虾USDT SHORT | 61 | 19.7% → 17.3% | 3/12 | 6 (12.2%) | 2/19 (10.5%) |
...
- logistic：保留後異常率 21.9%，攔截 227 個，其中異常 69 個；錯過正報酬代理 28.7%。
- extension：保留後異常率 24.2%，攔截 247 個，其中異常 62 個；錯過正報酬代理 36.8%。
- rejection_wick：保留後異常率 24.5%，攔截 0 個，其中異常 0 個；錯過正報酬代理 0.0%。
...
收盤長實體模型 AUC=0.5614；Brier=0.183808，按幣種／方向基準為 0.183969，改善很小。沒有找到可跨兩幣穩定採用的單一攔截條件。
