...
- 已收盤實體真突破上下軌，同輪直接送入結構化市價路由，不等 BTC／MA 方向、量能、利潤空間與候選排名；保留既有異常行情、同向上限、停損冷卻、價格安全與帳戶風控。回踩入口維持原濾網。
- 空單遇綠 K 實體上破上軌平空開多；多單遇紅 K 實體下破下軌平多開空。先確認平倉成功，再送反向候選。
- 真突破同輪先平舊倉，確認成功後立即送新倉；失敗且價格仍在對側外軌，後續直接重送並保留既有帳戶安全檢查；回到通道內取消重送資格。
...
- 空單 MA3 上穿 MA15，SL 設當下價上方滑價緩衝；多單 MA3 下穿 MA15，SL 設當下價下方滑價緩衝。包含正在形成的 K 線交叉，當輪立即鎖損益；SL 只往有利方向移動。
