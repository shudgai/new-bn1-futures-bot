...
- 一般平倉必須同時符合：本次持倉 MA3 曾出持倉側外軌後回到通道內、MA15 到持倉側外軌距離占通道寬度，在最近已收線與即時 K 都嚴格不足 40%（禁止僅以未收線瞬間壓縮觸發）、價格嚴格過中軌（多單跌破、空單突破）。40% 邊界、價格僅碰中軌、MA3 仍在軌外、空間仍有 50%／60% 都不能單獨觸發一般平倉。
