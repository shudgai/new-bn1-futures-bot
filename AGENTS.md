...
- 新突破只接受相鄰序列：突破前一根收在通道內、突破根實體由通道內開盤穿出、緊接下一根已收盤仍在同側外軌，且即時價仍在同側。禁止回看舊突破補進場；未收盤確認不算。確認完成同輪送入結構化市價路由，不等 BTC／MA 方向、量能、利潤空間與候選排名；保留既有異常行情、同向上限、停損冷卻、價格安全與帳戶風控。回踩入口維持原濾網。
...
- 多單瀑布、連續異常 K、固定止損及帳戶風控仍可直接平倉。空單單根異常 K／單次 ticker 急漲不直接平倉；空單 MA3 上穿 MA15 觸發交叉鎖損益 SL（待確認上軌實體突破才平空／反手，保留固定止損及帳戶風控）。
