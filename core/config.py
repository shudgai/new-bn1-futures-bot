...
STRUCTURED_SUPPORT_ORDER_TIMEOUT_SEC = float(os.getenv("STRUCTURED_SUPPORT_ORDER_TIMEOUT_SEC", "120"))
...
# SUPPORT_PULLBACK 必須是有實體、有動能改善的收線反轉；成交改用支撐附近
# 的短效 Maker，不在反轉 K 棒收線後用市價追價。
...
TREND_EXTENSION_TARGET_PCT = float(os.getenv("TREND_EXTENSION_TARGET_PCT", "0.010"))
TREND_EXTENSION_GUARD_TRIGGER_PCT = float(os.getenv("TREND_EXTENSION_GUARD_TRIGGER_PCT", "0.006"))
TREND_EXTENSION_GUARD_EXIT_PCT = float(os.getenv("TREND_EXTENSION_GUARD_EXIT_PCT", "0.0035"))
