...
PIVOT_FAILURE_BUFFER_ATR = max(0.0, float(os.getenv("PIVOT_FAILURE_BUFFER_ATR", "0.15")))
...
# 預設與觸發門檻相同：達到4元就把止損移到「至少還有4元利潤」的位置
PROFIT_LOCK_FLOOR_USDT = max(0.0, float(os.getenv("PROFIT_LOCK_FLOOR_USDT", "4.0")))
