...
TRADE_AMOUNT_USDT = float(os.getenv("TRADE_AMOUNT_USDT", "150.0"))
...
WATCHDOG_BASE_TIMEOUT_SECONDS = 15
WATCHDOG_MAX_TIMEOUT_SECONDS = 30


# --- 動態趨勢風控與確認 ---
ENTRY_CONFIRMATION_ATR_MULTIPLIER = 0.5
BREAKEVEN_BUFFER_ATR = 0.1
PEAK_VOL_WEAK_THRESHOLD = 0.8
V_LINE_SILENCE_SECONDS = 60
ENTRY_VOLUME_MULTIPLIER = 1.2


# --- 即刻保本鎖與動態移動止損 ---
BREAKEVEN_ACTIVATE_ATR = 0.1
